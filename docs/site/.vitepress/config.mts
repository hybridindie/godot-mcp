...
export default withMermaid(defineConfig({
  ...
  title: 'godot-mcp',
  description:
    'Bridge an AI agent and a live Godot editor over MCP — inspect, mutate, run, verify. 184 tools across 29 gated toolsets; the server owns safety, the addon owns Godot.',
  base: BASE,
  outDir: 'dist',
  ...
  themeConfig: {
    ...
    footer: {
      message: '184 tools · 29 toolsets · contract version 1',
