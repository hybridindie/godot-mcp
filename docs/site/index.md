...
hero:
  ...
  tagline: 'A generic, game-agnostic MCP server for AI-driven Godot development — inspect, mutate, run, and verify a real project over the Model Context Protocol. 184 tools across 29 gated toolsets.'
  actions:
    - theme: brand
      text: What & why
      link: ./what-why
...
features:
  ...
  - title: 184 tools, gated on demand
