...
| Tool | Params | Returns | Class |
|------|--------|---------|-------|
| `godot_asset_import_asset` | `source: str`, `target_path: str`, `options?: dict`, `wait_for_scan: bool = false`, `timeout_ms: int = 5000` | `ImportAssetResult { imported, target_path, detected_type, scan_complete, loop_applied }` | `mutating` |
