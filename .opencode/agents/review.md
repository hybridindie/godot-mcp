...
4. **Cross-cutting contracts** (`@CLAUDE.md`, `@.opencode/rules/`) — the things easiest to get wrong:
...
5. **Docs** — `CLAUDE.md` / `AGENTS.md` / `docs/` updated when a contract or structure changes (required by `enforcement.md`'s PR checklist).
