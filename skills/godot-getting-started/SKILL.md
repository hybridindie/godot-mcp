...
- `godot_health_check()` returns `version` — if it isn't **2026.09.23**, this skill may be stale; rely on `godot_get_server_info()`'s toolset/tool inventory instead of the counts here.
